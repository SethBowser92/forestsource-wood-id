  ...
  return (
    <html lang="en"><body>
      ...
      <style>{`
        ...
        .btn-primary{padding:.5rem 1rem;border-radius:.75rem;background:black;color:white}
        .btn-outline{padding:.5rem 1rem;border-radius:.75rem;border:1px solid #ddd}
        .card{border:1px solid #eee;border-radius:1rem;padding:1.25rem;margin-bottom:1rem}
